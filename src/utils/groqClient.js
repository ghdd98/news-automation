...
export async function stage3Analysis(newsItem) {
    const prompt = `[산업/경제/기업 뉴스만 평가] 중요도 1-10점.

제목: ${newsItem.title}
설명: ${(newsItem.description || '').slice(0, 100)}

[1-4:제외] 산업무관(정치정쟁/사회이슈/연예/스포츠), 범죄/폭력/성범죄, 사건사고/산재/사망, 광고/홍보, 행사/세미나, 인터뷰/기고, 수상/CSR, 채용/인사, 단순출시(수치없음)
[7+] 기업실적/가이던스, 수주/계약, 증설/공장/양산, M&A/지분, 규제/보조금/정책 + 금액(억/조)/물량(%/대) 명시
[5-6] 7+조건 미충족→1-4로 하향
