...
export async function stage3Analysis(newsItem) {
    const prompt = `당신은 한국 경제/산업 뉴스 최종 분류 전문가입니다.

다음 뉴스를 정밀하게 분석하여 최종 점수와 키워드를 추출하세요.
...
점수 기준:
- 9-10점: 시장에 큰 영향을 미치는 핵심 뉴스 (대형 M&A, 정부 정책, 대규모 투자)
- 7-8점: 중요한 산업/기업 동향 (실적 발표, 신제품, 주요 계약)
- 5-6점: 참고할 만한 일반 산업 소식

반드시 아래 JSON 형식으로만 응답하세요:
{"score": 숫자, "keywords": ["키워드1", "키워드2"], "reason": "분류 근거"}`;
