 ...
 * - Groq 6개 → Google AI Studio 3개 (gemini-2.5-flash → gemma-4-26b → gemini-2.5-flash-lite) fallback
 */
...
async function runSingleStage(newsItems) {
  ...
  console.log(`   📍 Google: gemini-2.5-flash → gemma-4-26b → gemini-2.5-flash-lite`);
